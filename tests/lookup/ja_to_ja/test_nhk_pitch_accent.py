...
class TestNhkPitchAccent:
    ...
    def test_lookup(self):
        ...
        assert(inu_data[Fieldname.PITCH_ACCENT].get_data() == 'イ<span class="overline">ヌ</span>&#42780;')
        assert(hirumu_data[Fieldname.PITCH_ACCENT].get_data() == 'ヒ<span class="overline">ル</span>&#42780;ム')
