...
from cardbuilder.data_sources.word_data import word_data_factory, WordData
from cardbuilder.word_lists.word_list import WordList
from cardbuilder.word_lists.word import WordForm, Word
...
class SvlWords(WordList, ExternalDataDataSource):
    ...
    word_data_type = word_data_factory('SvlWordData', [Fieldname.SUPPLEMENTAL], [])
    ...
    def parse_word_content(self, word: Word, form: str, content: str) -> WordData:
        return self.word_data_type(word, form, {
